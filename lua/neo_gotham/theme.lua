...
local c = require('neo_gotham.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "Cursor", { fg = c.base1, bg = c.base6 })
  hl(0, "lCursor", { fg = c.base1, bg = c.base6 })
  hl(0, "CursorIM", { fg = c.base1, bg = c.base6 })
  hl(0, "TermCursor", { fg = c.base1, bg = c.base6 })
  hl(0, "TermCursorNC", { fg = c.base1, bg = c.base6 })
  hl(0, "Conceal", { fg = c.cyan, bg = 'NONE' })
  hl(0, "Directory", { fg = c.magenta, bg = 'NONE' })
  hl(0, "SpecialKey", { fg = c.red, bg = 'NONE', bold=true, })
  hl(0, "ErrorMsg", { fg = c.error, bg = c.bg, bold=true, })
  hl(0, "Search", { fg = c.line, bg = c.yellow })
  hl(0, "IncSearch", { fg = 'NONE', bg = 'NONE', reverse=true, })
  hl(0, "Substitute", { fg = 'NONE', bg = c.yellow })
  ...
  -- Code
  hl(0, "Comment", { fg = c.blue, bg = 'NONE' })
  ...
  hl(0, "Keyword", { fg = c.base5, bg = 'NONE' })
  hl(0, "Conditional", { fg = c.base5, bg = 'NONE' })
  hl(0, "Repeat", { fg = c.base5, bg = 'NONE' })
  hl(0, "Operator", { fg = c.base5, bg = 'NONE' })
  ...
  hl(0, "Identifier", { fg = c.base5, bg = 'NONE' })
  ...
  hl(0, "TSVariableBuiltin", { fg = c.blue, bg = 'NONE' })
  ...
  hl(0, "TSSymbol", { fg = c.base5, bg = 'NONE' })
  hl(0, "TSField", { fg = c.base5, bg = 'NONE' })
  hl(0, "TSProperty", { fg = c.base5, bg = 'NONE' })
  ...
  -- NvimTree
  hl(0, "NvimTreeFolderIcon", { fg = c.magenta, bg = 'NONE' })
  hl(0, "NvimTreeIndentMarker", { fg = c.light_gray, bg = 'NONE' })
  hl(0, "NvimTreeNormal", { fg = c.fg, bg = c.alt_bg })
  hl(0, "NvimTreeVertSplit", { fg = c.blue, bg = c.alt_bg })
  ...
  hl(0, "NvimTreeSpecialFile", { fg = c.yellow, bg = 'NONE', underline=true, })
  ...
  -- BufferLine
  hl(0, "BufferLineBufferVisible", { fg = c.fg, bg = c.base2 })
  hl(0, "BufferLineBackground", { fg = c.fg, bg = c.base2 })
  hl(0, "BufferLineFill", { fg = c.base5, bg = c.base2 })
  hl(0, "BufferLineCloseButton", { fg = c.base5, bg = c.base2 })
  hl(0, "BufferLineCloseButtonVisible", { fg = c.base5, bg = c.base2 })
  hl(0, "BufferLineSeparator", { fg = c.base2, bg = 'NONE' })

  -- StatusLine
  hl(0, "StatusLine", { fg = c.context, bg = c.base2 })
  ...
  hl(0, "CmpItemAbbrMatch", { fg = c.orange, bg = 'NONE' })
  hl(0, "CmpItemAbbrMatchFuzzy", { fg = c.orange, bg = 'NONE' })
  ...
  hl(0, "CmpItemKindModule", { fg = c.green, bg = 'NONE' })
  ...
  hl(0, "NavicIconsModule", { fg = c.green, bg = 'NONE' })
